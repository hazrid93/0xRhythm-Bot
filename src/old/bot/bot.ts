            ...
            .on('join', (cmd: SuccessfulParsedMessage<Message>, msg: Message) => {
                joinUserChannel(msg)
                    .then((connection) => {
                        ...
                        msg.channel.send(createInfoEmbed(`Joined Channel: ${connection.channel.name}, Version: ${process.env.VERSION}, Info: ${process.env.INFO}`));
                    ...
                    if (embed) {
                        if (reaction.emoji.name === this.config.emojis.addSong && embed.url) {
                            ...
                            this.player.addMedia({
                                ...
                                this.logger.error(`Error adding media: ` + error);
                            })
